          ...
          >
            <div className="p-8 lg:p-12 flex flex-col justify-center">
              <div className="mb-8">
                ...
                <p className="text-slate-500 dark:text-slate-400">
                  Sign in to access your intelligent neural workspace.
                </p>
              </div>
            ...
            <div className="hidden lg:flex flex-col justify-between p-12 bg-primary relative overflow-hidden text-white">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-4xl font-black leading-tight mb-6">The future of collective intelligence.</h2>
                <p className="text-white/80 text-lg leading-relaxed max-w-sm">
                  Centralize your knowledge with our enterprise-grade AI engine. Instant answers, smart synthesis, and
                  global search.
                </p>
              </div>
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <p className="font-bold text-sm">Smart Summary</p>
                    <p className="text-xs text-white/60">Generated 2m ago</p>
                  </div>
                </div>
                <p className="text-sm leading-relaxed text-white/90 italic">
                  &quot;Our analysis of the Q3 reports suggests a 24% increase in operational efficiency after
                  implementing the new vector database structure...&quot;
                </p>
              </motion.div>
            </div>
          </motion.div>
