        ...
        return (
            <div className="relative flex min-h-screen items-center justify-center w-full bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-slate-100 p-4">
                <div className="text-center p-12 rounded-2xl border border-green-200 dark:border-green-900/40 bg-white dark:bg-slate-900 shadow-2xl max-w-md w-full">
                    ...
                    <h2 className="text-2xl font-black mb-3 text-slate-900 dark:text-slate-100 tracking-tight">Check your email!</h2>
                    <p className="text-slate-500 dark:text-slate-400 leading-relaxed mb-8">{success}</p>
                    <Link href="/login" className="inline-block w-full py-3 bg-primary hover:bg-primary/90 text-white font-bold rounded-lg transition-all shadow-lg shadow-primary/20">
                        Proceed to Sign In
                    </Link>
                </div>
            </div>
            ...
            <div className="flex h-full grow flex-col">
                ...
                <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-slate-200 dark:border-slate-800 px-6 lg:px-40 py-4 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md sticky top-0 z-50">
                    ...
                    <div className="flex items-center gap-4">
                        <Link className="text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-primary transition-colors" href="#">Documentation</Link>
                    </div>
                </header>
                ...
                <main className="flex-1 flex items-center justify-center p-6 lg:p-12">
                    ...
                    >
                        ...
                        <div className="p-8 lg:p-12 flex flex-col justify-center lg:order-2">
                            <div className="mb-8">
                                <h1 className="text-3xl font-black tracking-tight text-slate-900 dark:text-slate-100 mb-2">Create Account</h1>
                                <p className="text-slate-500 dark:text-slate-400">Start your journey with AI-powered knowledge management.</p>
                            </div>
                            ...
                            <p className="mt-8 text-center text-sm text-slate-500">
                                ...
                                <Link className="font-bold text-primary hover:underline" href="/login">Sign in</Link>
                            </p>
                        </div>
                        ...
                        <div className="hidden lg:flex flex-col justify-between p-12 bg-indigo-900 border-r border-slate-800/10 dark:border-slate-800 relative overflow-hidden text-white lg:order-1">
                            ...
                            <div className="relative z-10">
                                ...
                                <h2 className="text-4xl font-black leading-tight mb-6">Transform your reading process.</h2>
                                <p className="text-white/80 text-lg leading-relaxed max-w-sm">
                                    Join 10,000+ researchers and students who use our platform to learn 10x faster with AI generated summaries, flashcards, and quizzes.
                                </p>
                            </div>
                            ...
                            >
                                ...
                                <p className="text-sm leading-relaxed text-white/90 italic mb-4">
                                    "This absolutely changed how I study for my medical exams. The automated flashcards and knowledge graphs made retaining complex information effortless."
                                </p>
                                <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 rounded-full bg-slate-300"></div>
                                    <div>
                                        <h4 className="text-xs font-bold text-white">Sarah Jenkins</h4>
                                        <p className="text-[10px] text-white/60">Medical Student</p>
                                    </div>
                                </div>
                            </motion.div>
                        </div>
                ...
                <footer className="px-6 lg:px-40 py-8 text-center text-slate-500 dark:text-slate-400 text-xs">
                    <p>
                        © 2026 AI Knowledge Base Inc. All rights reserved.
