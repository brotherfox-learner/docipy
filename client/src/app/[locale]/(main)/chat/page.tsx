  ...
  return (
    <section className="max-w-6xl">
      <header className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-black tracking-tight text-slate-900 dark:text-white">Chat</h1>
          <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
            Choose a document to ask questions about its content. Answers use that document as context.
          </p>
        </div>
        <Link
          href="/documents"
      ...
      {isLoading ? (
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-10 text-center dark:border-slate-800 dark:bg-slate-900">
          ...
          <h2 className="text-lg font-bold text-slate-900 dark:text-white">No documents yet</h2>
          <p className="mx-auto mt-2 max-w-md text-sm text-slate-500 dark:text-slate-400">
            Create a document first, then open chat here to talk about that document&apos;s content.
          </p>
          <Link
            href="/documents/new"
