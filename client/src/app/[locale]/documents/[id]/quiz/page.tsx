        ...
        <div className="mx-auto flex w-full max-w-3xl flex-1 flex-col px-6 py-8">
          ...
          {listLoading ? (
            <AiGeneratingPanel
              ...
              description="Fetching saved quiz sets for this document."
            />
          ) : generateLoading && quizzes.length > 0 ? (
            <AiGeneratingPanel
              title="Building your quiz..."
              description="This can take up to a minute. Stay on this page while we draft a new question set from your document."
            />
          ) : (
            <>
              {quizzes.length === 0 ? (
                <DocumentFeatureEmptyState
                  ...
                  generatingTitle="Building your quiz..."
                  generatingDescription="This can take up to a minute. Stay on this page while we draft questions from your document."
                  primaryAction={
                    <button
                      type="button"
                      onClick={() => void handleGenerate()}
